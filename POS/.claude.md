# Claude Code Rules for omniPOS

This file contains project-specific rules and conventions for Claude Code when working on the omniPOS application.
...
*Project: omniPOS - Modern POS System for ERPNext*
