...
export function useShift() {
	...
	const checkOpeningShift = createResource({
		url: "omnipos.api.shifts.check_opening_shift",
		auto: false,
		onSuccess(data) {
			if (data) {
	...
	const getOpeningDialogData = createResource({
		url: "omnipos.api.shifts.get_opening_dialog_data",
		auto: false,
	})

	// Create new opening shift
	const createOpeningShift = createResource({
		url: "omnipos.api.shifts.create_opening_shift",
	...
	const getClosingShiftData = createResource({
		url: "omnipos.api.shifts.get_closing_shift_data",
	...
	const submitClosingShift = createResource({
		url: "omnipos.api.shifts.submit_closing_shift",
