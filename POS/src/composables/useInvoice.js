...
export function useInvoice() {
	...
	const updateInvoiceResource = createResource({
		url: "omnipos.api.invoices.update_invoice",
		makeParams(params) {
	...
	const validateCartItemsResource = createResource({
		url: "omnipos.api.invoices.validate_cart_items",
	...
	const getItemDetailsResource = createResource({
		url: "omnipos.api.items.get_item_details",
		auto: false,
	})

	const getTaxesResource = createResource({
		url: "omnipos.api.pos_profile.get_taxes",
		auto: false,
	})

	const getDefaultCustomerResource = createResource({
		url: "omnipos.api.pos_profile.get_default_customer",
	...
	const cleanupDraftsResource = createResource({
		url: "omnipos.api.invoices.cleanup_old_drafts",
		auto: false,
	})
