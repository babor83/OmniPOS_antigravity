...
const promotionsResource = createResource({
	url: "omnipos.api.promotions.get_promotions",
	makeParams() {
		return {
...
const itemGroupsResource = createResource({
	url: "omnipos.api.promotions.get_item_groups",
	makeParams() {
...
const brandsResource = createResource({
	url: "omnipos.api.promotions.get_brands",
	auto: false,
	onSuccess(data) {
		brands.value = data || []
	},
...
const savePromotionResource = createResource({
	url: "omnipos.api.promotions.create_promotion",
	makeParams() {
...
const updatePromotionResource = createResource({
	url: "omnipos.api.promotions.update_promotion",
	makeParams() {
		return {
...
const toggleResource = createResource({
	url: "omnipos.api.promotions.toggle_promotion",
	auto: false,
	onSuccess() {
...
const deleteResource = createResource({
	url: "omnipos.api.promotions.delete_promotion",
	auto: false,
	onSuccess(data) {
		const responseData = data?.message || data
		const successMessage =
...
const promotionDetailsResource = createResource({
	url: "omnipos.api.promotions.get_promotion_details",
	makeParams() {
		return {
