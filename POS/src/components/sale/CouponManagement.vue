...
const couponsResource = createResource({
	url: "omnipos.api.promotions.get_coupons",
	makeParams() {
		return {
			company: props.company,
...
const couponDetailsResource = createResource({
	url: "omnipos.api.promotions.get_coupon_details",
	makeParams() {
...
const createCouponResource = createResource({
	url: "omnipos.api.promotions.create_coupon",
	makeParams() {
...
const updateCouponResource = createResource({
	url: "omnipos.api.promotions.update_coupon",
	makeParams() {
		return {
...
const toggleCouponResource = createResource({
	url: "omnipos.api.promotions.toggle_coupon",
	makeParams() {
		return { coupon_name: selectedCoupon.value?.name }
	},
	auto: false,
...
const deleteCouponResource = createResource({
	url: "omnipos.api.promotions.delete_coupon",
	makeParams() {
		return { coupon_name: selectedCoupon.value?.name }
	},
	auto: false,
