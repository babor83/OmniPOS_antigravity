...
const loadBrandingConfig = async () => {
	try {
		const response = await call('omnipos.api.branding.get_branding_config')
...
const validateWithServer = async () => {
	...
	try {
		await call('omnipos.api.branding.validate_branding', {
...
const logClientEvent = async (eventType, details = {}) => {
	try {
		await call('omnipos.api.branding.log_client_event', {
